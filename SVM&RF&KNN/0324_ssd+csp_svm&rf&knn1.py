...
drive.mount('/content/SSD8~30_FBCSP8~30_overlap90%')

pwd

!ls "/content/SSD8~30_FBCSP8~30_overlap90%/My Drive/SSD8~30_FBCSP8~30_overlap90%"
...
label_files=[]
data_files=[]
for f in glob.glob("/content/SSD8~30_FBCSP8~30_overlap90%/My Drive/SSD8~30_FBCSP8~30_overlap90%/*.npy"):
  if "data" in f:
    data_files.append(f)
    # data = np.load(f)
