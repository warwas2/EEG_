...
def __read_eeg_file(left_data_file, right_data_file, time_length, time_window, epoch_size=None):
    ...
    if epoch_size is not None:
        ...
        left_data2 = epoch2(left_data, epoch_size)
        right_data2 = epoch2(right_data, epoch_size)

    print("left_data 길이:{}".format(len(left_data)))
    print("left_data2 길이:{}".format(len(left_data2)))
    print("left_data 길이:{}".format(len(right_data)))
