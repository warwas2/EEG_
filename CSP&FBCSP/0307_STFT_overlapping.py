from src.data_preparation.data_preparation_v2_20200307_2000overlap import read_eeg_file
...
#    왼손 
    ...
    for i in data.left_data:
        ...
        for idx in range(0,3):
            imgname="images_2000_10_overlap/sub"+str(subject)+"/ch"+str(idx+1)+"/sub"+str(subject)+"_left_"+str(cnt)+"_ch"+str(idx+1)+".png"
...
#    오른손 
    ...
    for i in data.right_data:
        ...
        for idx in range(0,3):
            imgname="images_2000_10_overlap/sub"+str(subject)+"/ch"+str(idx+1)+"/sub"+str(subject)+"_right_"+str(cnt)+"_ch"+str(idx+1)+".png"
#            imgname="all_images/ch"+str(idx+1)+"/sub"+str(subject)+"_left_"+str(cnt)+"_ch"+str(idx+1)+".png"
